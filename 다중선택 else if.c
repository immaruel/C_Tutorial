...
#define BASIC_DEDUTION 1500000.0
...
int main()
{
	...
	{
		tax = BASE1 * RATE1 + (BASE2 - BASE1) * RATE2 + (BASE3 - BASE2) * RATE3 + (BASE24 - BASE3) * RATE4 + (BASE25 - BASE4) * RATE5 + (income - BASE5) * RATE6;
	}
	else // if (if (income > BASE6)
	{
		tax = BASE1 * RATE1 + (BASE2 - BASE1) * RATE2 + (BASE3 - BASE2) * RATE3 + (BASE24 - BASE3) * RATE4 + (BASE25 - BASE4) * RATE5 + (BASE6 - BASE5) * RATE6 + (income - BASE6) * RATE7;
	}
